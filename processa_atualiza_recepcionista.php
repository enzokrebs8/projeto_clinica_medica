<?php
    ...
    $consulta = "UPDATE recepcionistas SET nome = '$nome_novo', email = '$email_novo', senha = '$hash', telefone='$telefone_novo', RG='$rg_n', CPF='$cpf_n', nascimento='$nascimento_novo' WHERE IDRecepcionista = '$id'";
