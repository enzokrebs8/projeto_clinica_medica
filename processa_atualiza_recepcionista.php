<?php
    ...
    $consulta = "UPDATE recepcionistas SET nome = '$nome_novo', email = '$email_novo', senha = '$hash', telefone='$telefone_novo', RG='$RG_novo', CPF='$CPF_novo', CPF='$CPF_novo', nascimento='$nascimento_novo' WHERE IDRecepcionista = '$id'";
