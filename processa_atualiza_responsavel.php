<?php
    ...
    $consulta = "UPDATE responsavel SET nome = '$nome_novo', email = '$email_novo', senha = '$hash', telefoneResp='$telefone_novo', RG='$rg_n', CPF='$cpf_n', nascimento='$nascimento_novo', IDEndereco='$IDEndereco_novo', IDPacienteMenor ='$IDPacienteMenor_novo' WHERE IDResponsavel = '$id'";
