<?php
    ...
    $consulta = "UPDATE medicos SET nome = '$nome_novo', email = '$email_novo', senha = '$hash', telefone='$telefone_novo', Especialidade='$Especialidade_nova', RG='$RG_novo', CPF='$CPF_novo', CRM='$CRM_novo', CPF='$CPF_novo', nascimento='$nascimento_novo' WHERE IDMedico = '$id'";
