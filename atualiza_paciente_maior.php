<?php
    ...
    $sql = "SELECT * FROM pacientemaior WHERE IDPacienteMaior = '$id'";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <form action="processa_atualiza_paciente_maior.php?id=<?php echo $id; ?>" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="telefoneEmergencia_novo" type="text" class="form-control" value="<?php echo $dados['telefone']; ?>">                                    
                                </div>
                                <div class="mb-3">
