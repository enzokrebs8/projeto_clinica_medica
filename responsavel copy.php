            ...
            <h2 class="calcaangelical">Consultas agendadas</h2>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <?php 
                                    $IDResp = $_SESSION['id'];
                                    $queryMenor = "SELECT IDPacienteMenor FROM pacientemenor WHERE IDResponsavel = '$IDResp'";
                                    $resultMenor = $conexao->query($queryMenor);
                                    
                                    if ($resultMenor && $resultMenor->num_rows > 0) {
                                        $rowMenor = $resultMenor->fetch_assoc();
                                        $IDMenor = $rowMenor['IDPacienteMenor'];
                                    } else {
                                        die("Nenhum paciente menor associado ao responsável encontrado.");
                                    }
